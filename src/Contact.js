...
import "./Contact.css";
import clappingCat from "./assets/cat-jump.gif";
...
export default function Contact(){
    ...
    return (
        <div className="parentbox"> 
            ...
            {/* Puts the clapping cat gif on screen when the submit button is pressed */}
            {submitted ? <img src={clappingCat} alt="clapping cat"></img> : <></>}
